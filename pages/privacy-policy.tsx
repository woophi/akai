...
const PP = () => {
  return (
    <Layout title="Privacy Policy">
      <BoxGrid>
        <Box padding=".5rem">
          <h1>Privacy Policy for Akai Akaev</h1>

          <p>
            At Akai Akaev, accessible from https://akaiakaev.com/, one of our main priorities is the privacy of our visitors.
            This Privacy Policy document contains types of information that is collected and recorded by Akai Akaev and how
            we use it.
          </p>
          ...
          <p>
            ...
            to the information that they shared and/or collect in Akai Akaev. This policy is not applicable to any
          ...
          <p>
            Akai Akaev follows a standard procedure of using log files. These files log visitors when they visit websites.
          ...
          <p>
            Like any other website, Akai Akaev uses 'cookies'. These cookies are used to store information including
          ...
          <p>You may consult this list to find the Privacy Policy for each of the advertising partners of Akai Akaev.</p>

          <p>
            Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are used in
            their respective advertisements and links that appear on Akai Akaev, which are sent directly to users' browser.
          ...
          <p>
            Note that Akai Akaev has no access to or control over these cookies that are used by third-party advertisers.
          </p>

          <h2>Third Party Privacy Policies</h2>

          <p>
            Akai Akaev's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to consult
          ...
          <p>
            Akai Akaev does not knowingly collect any Personal Identifiable Information from children under the age of 13. If
