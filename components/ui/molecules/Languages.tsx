...
export const Languages: React.FC = React.memo(() => {
  ...
  return (
    <div className={classes.content}>
      <img onClick={() => changeLanguage('en', i18n)} className={classes.img} src="/img/en.png" alt="language_en" />
      <img onClick={() => changeLanguage('ru', i18n)} className={classes.img} src="/img/ru.png" alt="language_ru" />
      <img onClick={() => changeLanguage('cs', i18n)} className={classes.img} src="/img/cz.png" alt="language_cz" />
    </div>
  );
});
