...
export const hasRoleAdmin = createSelector(getUserRoles, roles => roles.indexOf(IROLES.ADMIN) !== -1);
export const hasRoleSuperAdmin = createSelector(getUserRoles, roles => roles.indexOf(IROLES.GODLIKE) !== -1);
